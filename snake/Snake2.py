...
class Snake(Cube):
    ...
    def update(self):
        ...
        if event_sing.type == pygame.KEYDOWN:
            if event_sing.key == pygame.K_LEFT:
                if self.dir_x != 1:
                    self.dir_x = -1
                    self.dir_y = 0

            if event_sing.key == pygame.K_RIGHT:
                if self.dir_x != -1:
                    self.dir_x = 1
                    self.dir_y = 0

            if event_sing.key == pygame.K_UP:
                if self.dir_y != 1:
                    self.dir_y = -1
                    self.dir_x = 0

            if event_sing.key == pygame.K_DOWN:
                if self.dir_y != -1:
                    self.dir_y = 1
                    self.dir_x = 0
        ...
        if l_body > self.length + 1: self.body.pop(l_body - 1)
